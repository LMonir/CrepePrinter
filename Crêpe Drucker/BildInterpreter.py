...
def process_image(image):
    if image.size != (42, 42):
        raise Exception("Das Bild muss 42x42 Pixel groß sein.")
...
def create_gcode(x, y):
    return f"G1 X{x} Y{y}"  # Hier können Sie Ihren GCode anpassen, je nach Bedarf
